...
async function updateWebVersion() {
  ...
  try {
    ...
    webVersionLabel.textContent = `WEB v${system.webAdminVersion || '3.5.3'} · UI ${WEB_UI_REVISION}`;
  } catch (_) {
    webVersionLabel.textContent = `WEB v3.5.3 · UI ${WEB_UI_REVISION}`;
  }
}
