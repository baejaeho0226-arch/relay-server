...
async function renderDangerZone() {
  ...
  content.innerHTML = `<div class="danger-banner"><strong>!! DANGER ZONE !!</strong><span>위험 작업은 영향 범위를 확인한 뒤 Web 모달에서 한 번 더 승인합니다. 별도 확인 문구 입력은 사용하지 않습니다.</span></div><div class="danger-grid">
    ...
    <div class="section-card danger-card"><div class="section-head"><h3>All History Clean</h3><span class="small-note">ACTIVE DATA PRESERVED</span></div><div class="section-body"><p class="muted">완료된 Trace, Build, QR, Config, Daily, DLQ, Notification, Audit 이력을 한 번에 정리합니다. 진행 중 데이터는 보존됩니다.</p><button class="danger" data-history-clean="ALL">CLEAN ALL HISTORY</button></div></div>
