...
const CACHE = 'relay-admin-shell-v4.2.0-fix13';
const SHELL = [
  "/index.html",
  "/admin.css?v=4.2.0-fix13",
  "/admin-theme.css?v=4.2.0-fix13",
  "/admin-navigation.css?v=4.2.0-fix13",
  "/admin-i18n.js?v=4.2.0-fix13",
  "/admin.js?v=4.2.0-fix13",
  "/admin-navigation.js?v=4.2.0-fix13",
  "/admin-pages-monitoring.js?v=4.2.0-fix13",
  "/admin-terminal.js?v=4.2.0-fix13",
  "/admin-pages-traffic.js?v=4.2.0-fix13",
  "/admin-pages-danger.js?v=4.2.0-fix13",
  "/admin-pages-access.js?v=4.2.0-fix13",
  "/admin-pages-sessions.js?v=4.2.0-fix13",
  "/admin-pages-reports.js?v=4.2.0-fix13",
  "/admin-pages-devices.js?v=4.2.0-fix13",
  "/admin-pages-qr.js?v=4.2.0-fix13",
  "/admin-pages-licenses.js?v=4.2.0-fix13",
  "/admin-pages-deployment.js?v=4.2.0-fix13",
  "/admin-pages-security.js?v=4.2.0-fix13",
  "/admin-pages-operations.js?v=4.2.0-fix13",
  "/admin-pages-support.js?v=4.2.0-fix13",
  "/admin-actions-access.js?v=4.2.0-fix13",
  "/admin-actions-operations.js?v=4.2.0-fix13",
  "/admin-actions-traffic.js?v=4.2.0-fix13",
  "/admin-actions-devices.js?v=4.2.0-fix13",
  "/admin-actions-policy.js?v=4.2.0-fix13",
  "/admin-actions-system.js?v=4.2.0-fix13",
  "/admin-modal.js?v=4.2.0-fix13",
  "/admin-device-actions.js?v=4.2.0-fix13",
  "/admin-license-actions.js?v=4.2.0-fix13",
  "/admin-actions.js?v=4.2.0-fix13",
  "/admin-pages-member.js?v=4.2.0-fix13",
  "/admin-palette.js?v=4.2.0-fix13",
  "/admin-pages-production.js?v=4.2.0-fix13",
  "/ui-refresh.html",
  "/ui-refresh.js?v=4.2.0-fix13",
  "/manifest.json",
  "/icons/icon-192.png",
  "/icons/icon-512.png"
];
