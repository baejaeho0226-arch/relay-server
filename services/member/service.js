...
function Execute(c,requestId,action,body={}){
 ...
 if(read[action]){
  ...
  return require('./readResponse').Pack(data,s.PublicProfile(p),s.DB().revision,body);
 }
 const mutations={
