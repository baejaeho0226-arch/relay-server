...
(async()=>{try{
 ...
 field('detail_developer','테스트 제작사');field('minimum_os','Windows 10');field('channel_official','https://example.com/game');
