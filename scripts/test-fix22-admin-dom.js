...
(async()=>{try{
 ...
 assert.equal(content.querySelectorAll('.member-lookup-tabs button').length,9);
 ...
 console.log('FIX22 ADMIN DOM PASS: exact @handle search, all nine dossier sections, phone and biometric cards, safe text, paging, profile limits in real API, shared genre colors');
